    ...
    <footer className="bg-black text-white py-12 px-6 mt-auto">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                <svg className="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C6.477 2 2 6.145 2 11.243c0 2.9 1.441 5.487 3.694 7.177V22l3.475-1.908c.927.256 1.907.394 2.925.394 5.523 0 10-4.145 10-9.243C22 6.145 17.523 2 12 2zm1.042 12.443l-2.586-2.757-5.049 2.757 5.556-5.9 2.648 2.757 4.987-2.757-5.556 5.9z" />
                </svg>
              </a>
              <a
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-gray-400 text-sm">
          <p>© 2025 | TaskMate Web Solutions</p>
          <p>Reg no. xxxxxxxxxxxxxxxx</p>
        </div>
      </div>
    </footer>
  );
